 ...
 */
final class Version20230108164328 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE user ADD prenom VARCHAR(60) NOT NULL, ADD nom VARCHAR(60) NOT NULL, ADD pseudo VARCHAR(60) DEFAULT NULL, ADD created_at DATETIME NOT NULL, ADD update_at DATETIME DEFAULT NULL, ADD actif TINYINT(1) NOT NULL');
    }
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE user DROP prenom, DROP nom, DROP pseudo, DROP created_at, DROP update_at, DROP actif');
    }
}
